...
sealed class TimestampModel {
    ...
    data class Week(@StringRes val timestamp: Int = R.string.week, val days: Int = 7) :
        TimestampModel()

    data class Month(@StringRes val timestamp: Int = R.string.month, val days: Int = 31) :
        TimestampModel()

    data class TwoWeeks(@StringRes val timestamp: Int = R.string.two_weeks, val days: Int = 14) :
        TimestampModel()
